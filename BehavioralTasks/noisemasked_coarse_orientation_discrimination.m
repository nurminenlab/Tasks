...
if strcmp(animal,'Sansa')
  ...
  contrasts = [0.01 0.02 0.04 0.08];
  contrasts_idx = [1 1 2 2 3 3 4]; # workaround for weighted randomization of contrast
  mask_contrast = 0.1;
  orientations = [0,90];
  pix_per_period = 33;
  plateau_deg = 1.5;
...
elseif strcmp(animal,'Wolfjaw')
  ...
  gridSize = 128;
  contrasts = [0.08 0.16 0.32]; # target contrast
  contrasts_idx = [1 1 2 2 3]; # workaround for weighted randomization of contrast
  mask_contrast = 0.2;
  orientations = [0,90];
  pix_per_period = 33;
  plateau_deg = 3;

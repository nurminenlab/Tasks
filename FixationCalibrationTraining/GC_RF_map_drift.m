...
shiftperframe = cyclespersecond * pixelsPerPeriod * waitduration;
...
while is_running
  ...
  while on_target;     
    ...
    g = g +1;
    gaze_position(:,g) = XY;
    yoffset = mod(i_cyc*shiftperframe,pixelsPerPeriod);
    i_cyc=i_cyc+1;
    ...
    Screen('DrawTexture', eyeTrack_window, grText_iTR(text_ind), [], new_grating_rect, orientation, [], [], [], [], [], [0, yoffset, 0, 0]);
    Screen('DrawTexture', eyeTrack_window, eyeTrack_imageTexture, [], small_rects(:,:,pos));
    Screen('Flip', eyeTrack_window,0,1);
